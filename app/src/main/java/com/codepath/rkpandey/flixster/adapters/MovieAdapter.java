...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.ViewHolder>{
    ...
    // Holds references to each element in one row of the recycler view
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Movie movie) {
            ...
            String imageUrl;
            // Set url to corresponding orientation
            ...
            // Register click listener to know when to navigate to new activity
